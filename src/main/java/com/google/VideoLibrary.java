...
class VideoLibrary {
  ...
  VideoLibrary() {
    ...
    try {
      File file = new File("D:/Documents/Bright Network/google-code-sample-main/java/target/classes/videos.txt");
  ...
  List<Video> getVideos() {  return new ArrayList<>(this.videos.values());
  }
